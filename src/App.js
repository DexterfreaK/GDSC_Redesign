        ...
        <div id="link-box">
          <div id="wiki-found">
            <div class="wiki-found-img-cont">
              <img
                src="images\footer\wikimedia-found.png"
                alt="wiki-foundation"
              />
            </div>
          ...
          <div id="wiki-apps">
            <div class="app-cont">
              <img
                src="images/other-wikis/commons.png"
                alt="commons"
                class="app-icon"
              />
              <div class="app-info">
            ...
            <div class="app-cont">
              <img
                src="images/other-wikis/wikivoyage.png"
                alt="voyage"
                class="app-icon"
              />
              <div class="app-info">
            ...
            <div class="app-cont">
              <img
                src="images/other-wikis/wiktionary.png"
                alt="wiktionary"
                class="app-icon"
              />
              <div class="app-info">
            ...
            <div class="app-cont">
              <img
                src="images/other-wikis/wikibooks.png"
                alt="wikibooks"
                class="app-icon"
              />
              <div class="app-info">
            ...
            <div class="app-cont">
              <img
                src="images/other-wikis/wikinews.png"
                alt="wikinews"
                class="app-icon"
              />
              <div class="app-info">
            ...
            <div class="app-cont">
              <img
                src="images/other-wikis/wikidata.png"
                alt="wikidata"
                class="app-icon"
              />
              <div class="app-info">
            ...
            <div class="app-cont">
              <img
                src="images/other-wikis/wikiversity.png"
                alt="wikiversity"
                class="app-icon"
              />
              <div class="app-info">
            ...
            <div class="app-cont">
              <img
                src="images/other-wikis/wikiquote.png"
                alt="wikiquote"
                class="app-icon"
              />
              <div class="app-info">
            ...
            <div class="app-cont">
              <img
                src="images/other-wikis/mediawiki.png"
                alt="mediawiki"
                class="app-icon"
              />
              <div class="app-info">
            ...
            <div class="app-cont">
              <img
                src="images/other-wikis/wikisource.png"
                alt="wikisource"
                class="app-icon"
              />
              <div class="app-info">
            ...
            <div class="app-cont">
              <img
                src="images/other-wikis/wikispecies.png"
                alt="wikispecies"
                class="app-icon"
              />
              <div class="app-info">
            ...
            <div class="app-cont">
              <img
                src="images/other-wikis/metawiki.png"
                alt="metawiki"
                class="app-icon"
              />
              <div class="app-info">
