  ...
  return (
    <main className="main">
      ...
      <Box sx={{ display: "flex", flexDirection: "row" }}>
        ...
        >
          <Box
            sx={{ display: "flex", justifyContent: "space-between", mt: "2vh" }}
          >
            <Box sx={{ display: "flex", flexDirection: "row" }}>
          ...
          <Box>
            <Box sx={{ m: "3vh" }}>
              ...
              <Box sx={{ fontFamily: "arial" }}>
                ...
                Proin vitae facilisis nisi, ac posuere leo. Jorem ipsum dolor
        ...
        <Box sx={{ bgcolor: "#F8F9FA", width: "20vw" }}>
          <Box
            sx={{
              fontWeight: "600",
              fontSize: "2vh",
